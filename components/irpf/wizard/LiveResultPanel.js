...
export default function LiveResultPanel({ optimo, scenarios, ready }) {
  if (!ready) {
    return (
      <div className="bg-white rounded-3xl shadow-sm border border-border/60 p-10 text-center">
  ...
  return (
    <div className="bg-white rounded-3xl shadow-md border border-border/60 overflow-hidden">
      {/* Best scenario label */}
      <div
      ...
      >
        <div>
          <div className="text-[11px] font-bold tracking-[0.15em] uppercase" style={{ color: T.green }}>
            Mejor opción
          </div>
          <div className="text-sm font-bold text-ink">{optimo.label}</div>
        </div>
        <span
          className="text-[11px] font-bold tracking-[0.12em] uppercase px-3 py-1.5 rounded-lg"
      ...
      <div className="px-8 py-8">
        ...
        <div className="grid grid-cols-2 gap-3 mb-5">
          <div className="rounded-2xl p-5" style={{ background: T.surfaceAlt, border: `1px solid ${T.border}` }}>
            <div className="text-[11px] font-bold tracking-widest uppercase mb-1.5 text-ink-faint">
              Tipo efectivo
            </div>
              ...
              {[...scenarios]
                ...
                .map((sc, i) => {
                  ...
                  return (
                    <div
                      key={sc.id}
                      className="flex items-center justify-between px-5 py-3 rounded-2xl transition-colors duration-200"
                      style={{
                    ...
                    >
                      <div className="flex items-center gap-2">
                        <span
                          className="text-[11px] font-bold tracking-wider uppercase px-2 py-0.5 rounded-md"
                          style={{
